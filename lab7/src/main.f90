program lab_2_2
   ...
   implicit none
   integer, parameter               :: STUD_AMOUNT = 8, SURNAME_LEN = 15, INITIALS_LEN = 5
   character(kind=CH_), parameter   :: Native = Char(1055, CH_), FEMALE = Char(1057, CH_) ! zamenit
   ...
   call Read_class_list(input_file, Surnames, Initials, Genders, Registration, Aver_Marks)

   call Output_class_list(output_file, Surnames, Initials, Genders, Registration, Aver_Marks, &
...
contains
   ...
   subroutine Read_class_list(Input_File, Surnames, Initials, Genders, Marks, Aver_Marks)
      ...
      open (file=Input_File, encoding=E_, newunit=In)
         ...
         read (In, format, iostat=IO) (Surnames(i, :), Initials(i, :), Genders(i), Marks(i, :), Aver_Ma>
            i = 1, STUD_AMOUNT)
   ...
   ! Чтение списка класса: фамилии, инициалы, полы, оценки и средний.
  ! subroutine Read_class_list(Input_File, Surnames, Initials, Genders, Registration, Aver_Marks)
  !    character(*)         Input_File
  ...
  !       read (In, format, iostat=IO) (Surnames(i, :), Initials(i, :), Genders(i), Registration(i), Avg_Marks(i), &
  !          i = 1, STUD_AMOUNT)
  !       call Handle_IO_status(IO, "reading class list")
  !    close (In)
  ! end subroutine Read_class_list
   ...
   ! Вывод списка класса.
   subroutine Output_class_list(Output_File, Surnames, Initials, Genders, Registration, Aver_Marks, List_name, Position)
